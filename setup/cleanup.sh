...
echo "  temporal workflow terminate --query 'WorkflowType=\"BasicPipelineWorkflow\"'"
echo "  temporal workflow terminate --query 'WorkflowType=\"PipelineWithApprovalWorkflow\"'"
